...
export default function TopSellingProducts({ timeRange = 'month', limit = 5 }: TopSellingProductsProps) {
    ...
    const fetchTopProducts = async () => {
        try {
            setLoading(true);
            const response = await transactionService.getTopProducts(limit);
        ...
        return (
            <View style={[styles.container, { backgroundColor: colors.card }]}>
                <View style={styles.header}>
                    ...
                    <Text style={[styles.title, { color: colors.text }]}>Produk Terlaris</Text>
                </View>
