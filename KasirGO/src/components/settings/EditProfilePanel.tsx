...
import { X, UserCircle2, User, Mail, Phone } from "lucide-react-native";
...
export default function EditProfilePanel({ visible, onClose }: EditProfilePanelProps) {
                ...
                <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity
                            ...
                            disabled={loading}
                        >
                            {loading ? <ActivityIndicator color="#ffffff" /> : <Text style={styles.saveButtonText}>Simpan</Text>}
                        </TouchableOpacity>
                    </View>
