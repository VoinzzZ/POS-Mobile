...
import OwnerRegistrationContent from '@/src/components/auth/owner/OwnerRegistrationContent';
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <OwnerRegistrationContent onBackToRegisterType={handleBackToRegisterType} />
      </ImageBackground>
    </View>
  );
}
